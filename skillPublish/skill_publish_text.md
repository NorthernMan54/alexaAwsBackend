...
| Portuguese | Use a Alexa para controlar seus dispositivos associados ao HomeBridge. | Essa habilidade foi feita para usuários que usam o HomeBridge, e requer a instalação e configuração do HomeBridge, assim como o plugin HomeBridge-Alexa. Para mais informações visite https://homebridge.io.<BR><BR>Para começar, primeiro instale e configure o plugin homebridge-alexa, para mais detalhes visite https://github.com/NorthernMan54/homebridge-alexa. Uma vez que o plugin esteja instalado e configurado, selecione a opção "Ativar habilidade" no aplicativo da Alexa para vincular sua conta do homebridge e encontrar seus aparelhos.<BR><BR>Os dispositivos disponíveis do HomeBridge incluem:<BR><BR>Luzes, Plugs de tomada, Interruptores, Ventiladores, e sensores de temperatura. |
...
| Portuguese | Alexa, ligue a luminária da sala de estar | Alexa, ajuste luminária da sala de estar em 50 porcento | Alexa, desligue a luminária da sala de estar |
