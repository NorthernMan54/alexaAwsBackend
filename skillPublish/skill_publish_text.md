...
| Spanish ES, MX | Usa Alexa para controlar tus dispositivos asociados a HomeBridge. | Esta Skill permite controlar sus dispositivos asociados a Homebridge con Amazon Alexa.<BR><BR>Para ampliar información sobre Homebridge, consulte https://homebridge.io.<BR><BR>Para controlar sus dispositivos de Homebridge a través de Amazon Alexa es necesario que instale el plugin Homebridge-Alexa" tal y como se describe en https://github.com/NorthernMan54/homebridge-alexa<BR><BR>Los dispositivos en Homebridge compatibles son:<BR><BR>Luces, enchufes, interruptores, ventiladores y sensores de temperatura. |
