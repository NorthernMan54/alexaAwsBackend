...
| Spanish ES | Usa tu Alexa para controlar tus dispositivos asociados a HomeBridge. | Esta habilidad está dirigida a los usuarios de HomeBridge y requiere la instalación y configuración de HomeBridge y el complemento HomeBridge-Alexa. Para obtener más información sobre homebridge, consulte https://homebridge.io.<BR><BR>Para comenzar, primero instale y configure el complemento homebridge-alexa; los detalles están aquí https://github.com/NorthernMan54/homebridge-alexa. Una vez que haya instalado y configurado el complemento, seleccione el botón 'Habilitar habilidad' en la aplicación Alexa para vincular su cuenta de homebridge y descubrir sus dispositivos.<BR><BR>Los dispositivos homebridge compatibles incluyen:<BR><BR>Luces, puntos de venta, interruptores, ventiladores y sensores de temperatura. |
| Spanish MX | Usa tu Alexa para controlar tus dispositivos asociados a HomeBridge. | Esta habilidad está dirigida a los usuarios de HomeBridge y requiere la instalación y configuración de HomeBridge y el complemento HomeBridge-Alexa. Para obtener más información sobre homebridge, consulte https://homebridge.io.<BR><BR>Para comenzar, primero instale y configure el complemento homebridge-alexa; los detalles están aquí https://github.com/NorthernMan54/homebridge-alexa. Una vez que haya instalado y configurado el complemento, seleccione el botón 'Habilitar habilidad' en la aplicación Alexa para vincular su cuenta de homebridge y descubrir sus dispositivos.<BR><BR>Los dispositivos homebridge compatibles incluyen:<BR><BR>Luces, puntos de venta, interruptores, ventiladores y sensores de temperatura. |
